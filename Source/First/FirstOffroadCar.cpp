...
#include "FirstOffroadCar.h"
#include "FirstOffroadWheelFront.h"
#include "FirstOffroadWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"
#include "GameFramework/SpringArmComponent.h"

AFirstOffroadCar::AFirstOffroadCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFirstOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFirstOffroadWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFirstOffroadWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFirstOffroadWheelRear::StaticClass();
