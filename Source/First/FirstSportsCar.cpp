...
#include "FirstSportsCar.h"
#include "FirstSportsWheelFront.h"
#include "FirstSportsWheelRear.h"
#include "ChaosWheeledVehicleMovementComponent.h"

AFirstSportsCar::AFirstSportsCar()
{
	...
	GetChaosVehicleMovement()->WheelSetups[0].WheelClass = UFirstSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[1].WheelClass = UFirstSportsWheelFront::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[2].WheelClass = UFirstSportsWheelRear::StaticClass();
	...
	GetChaosVehicleMovement()->WheelSetups[3].WheelClass = UFirstSportsWheelRear::StaticClass();
