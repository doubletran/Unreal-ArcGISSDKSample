 ...
 */
UCLASS()
class FIRST_API AVehicle : public AWheeledVehiclePawn
{
	GENERATED_BODY()
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
	UArcGISCameraComponent* FrontCamera;
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadOnly, Category = Camera, meta = (AllowPrivateAccess = "true"))
	UArcGISCameraComponent* BackCamera;
...
public:
	...
	FORCEINLINE UArcGISCameraComponent* GetFollowCamera() const { return FrontCamera; }
	/** Returns the back spring arm subobject */
	FORCEINLINE USpringArmComponent* GetBackSpringArm() const { return BackSpringArm; }
	/** Returns the back camera subobject */
	FORCEINLINE UArcGISCameraComponent* GetBackCamera() const { return BackCamera; }
